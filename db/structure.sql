...
--
-- Name: notes fk_rails_cfc8432c20; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.notes
    ADD CONSTRAINT fk_rails_cfc8432c20 FOREIGN KEY (report_id) REFERENCES public.reports(id);
